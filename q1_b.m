...
% % Plot true state
% minislam.graphics.FigureManager.getFigure('true state');
% clf
% plot(results{1}.vehicleTrueStateHistory')
% legend('x','y','psi')
% hold on
% 
% % Plot estimated state
% minislam.graphics.FigureManager.getFigure('estimated state');
% clf
% plot(results{1}.vehicleStateHistory')
% legend('x','y','psi')
% hold on
